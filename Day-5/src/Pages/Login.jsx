  ...
  return (
    <div class="flex  items-center justify-center  min-h-screen bg-orange-300">
      ...
      >
        ...
        <Toaster/>
          <span className="mb-3 text-4xl font-bold text-orange-300">Hello!!!</span>
          ...
          <div class="py-4  justify-between">
            ...
            <input
              ...
              class="w-full p-2 border border-white hover:placeholder:text-black ouline-none hover:outline-none hover:bg-orange-300  rounded-md"
            ></input>
          ...
          <div class="py-4  justify-between">
            ...
            <input
              ...
              class=" w-full p-2 border border-white  rounded-md
                    ...
                    hover:text-black  hover:bg-orange-300  hover:outline-none ouline-none"
              onChange={handleChange}
            ></input>
          ...
          {/*  <div class="mr-24">
            ...
            <span class="font-serif text-md cursor-pointer hover:text-orange-300 hover:underline" onClick={notify}>
              Forget password ?
            </span>
          </div>
          <div class="flex flex-col space-y-2">
              ...
              class="w-full bg-black text-white p-2 rounded-lg mt-5
                 font-bold font-serif hover:text-black hover:bg-orange-300"
            >
              Sign in
            </button>
            ...
            <button class=" flex gap-4 justify-center w-full bg-black  font-serif text-white font-bold p-2 rounded-lg hover:bg-orange-300  hover:text-black ">
              <FcGoogle class="mt-1" />
              Sign in with Google
            </button>
          </div>
          <span className="hover:underline hover:text-orange-300 font-serif cursor-pointer" onClick={()=>nav('/signup')}>Doesn't have an account? Signup</span>
        </div>
      </form>
    </div>
  );
