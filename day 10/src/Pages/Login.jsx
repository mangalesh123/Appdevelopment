...
const Login = () => {
  ...
  return (
    <div class="flex  items-center justify-center  min-h-screen bg-green-400">
      ...
      >
        ...
        <Toaster/>
          ...
          <div class="flex flex-col space-y-2">
            ...
            <button class=" flex gap-4 justify-center w-full bg-black  font-serif text-white font-bold p-2 rounded-lg hover:bg-green-600  hover:text-black ">
              <FcGoogle class="mt-1" />
              Sign in with Google
            </button>
          </div>
