...
const Signup =()=>{
  ...
  const [errors,setErrors] = useState({})
    ...
    return(
        <div className="flex items-center w-full min-h-screen justify-center bg-green-400">
            ...
            <form onSubmit={handleSubmit} class="relative flex flex-col m-6 space-y-0 bg-white shadow-2xl rounded-2xl md:flex-row md:space-x-0">
                ...
                <button class=" flex gap-4 justify-center font-serif w-full bg-black  text-white font-bold p-2 rounded-lg hover:bg-green-600  hover:text-black ">
                <FcGoogle class="mt-1"/>
                    Sign up with Google
                </button>
                <div class="flex   cursor-pointer">
                <span>Already have an account?{" "}
                <p className="hover:underline hover:text-green-600" onClick={()=>nav('/')}>Login</p></span>
                </div>
                </div>
